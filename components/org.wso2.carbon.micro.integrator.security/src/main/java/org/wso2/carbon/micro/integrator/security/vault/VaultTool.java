...
public class VaultTool {
    ...
    private static void initialize(String[] args) {
        ...
        for (String arg : args) {
            if (arg.equals("-help")) {
                ...
                switch (property) {
                    case Constants.CONSOLE_DONT_STORE_PARAM:
    ...
    private static void printHelp() {
        ...
        System.out.println("\t-DdontStore\t\t This option allows the user to obtain the encrypted " +
                "string of a password\n");
        ...
        while (true) {
            ...
            if (!firstPassword.isEmpty() && firstPassword.equals(secondPassword)) {
                if (firstPassword.length() < 7) {
                    System.out.println("Password must contain more than six characters, Please Re-enter password\n\n");
                    continue;
                }
